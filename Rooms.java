...
room[2][4].setExits(exits);
      ...
      exits[0] = "n"; exits[1] = ""; exits[2] = "e"; exits[3] = "";
        ...
        room[4][4].setDescription("You are in the garage. It smells like bleach and there are plastic tarps on the floor.");
...
room[4][4].setExits(exits);
      ...
      exits[0] = ""; exits[1] = ""; exits[2] = "e"; exits[3] = "w";
        ...
        room[3][5].setDescription("You are in the family room. There are no family photographs or personalized items.");
